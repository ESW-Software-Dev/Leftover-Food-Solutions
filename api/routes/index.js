...
router.get(
  "/get-users-saved-posts/:id",
  post_controller.get_posts_saved_by_user
);
router.get(
  "/get-users-claimed-posts/:id",
  post_controller.get_posts_claimed_by_user
);
// upload
router.post(
  "/upload-post",
  upload.single("image"),
  post_controller.upload_post
);
// delete
